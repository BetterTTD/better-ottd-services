...
export default class ClientService {
    ...
    Observe(client) {
        ...
        client.on('error', (error) => {
            ...
            this.clients = [...this.clients.filter(c => c.id !== error.id)];
        });
        ...
        client.on('clientupdate', (clientUpdate) => {
